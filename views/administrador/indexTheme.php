...
where datediff(curdate(), p.fechaDevolver)>0 and p.estado=1 and year(fechaRealizacion) = "'.$anio.'"';
                      $c = $con->query($sql);
                      $c = $c->fetch_assoc();
            ...
            <div class="col-xl-10 col-lg-10">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Préstamos Mensuales</h6>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Universidad Albert Einstein 2019</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <script src="/sistemaUAE/resources/bootstrap/vendor/jquery/jquery.min.js"></script>
  <script src="/sistemaUAE/resources/bootstrap/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- Core plugin JavaScript-->
  <script src="/sistemaUAE/resources/bootstrap/vendor/jquery-easing/jquery.easing.min.js"></script>

  <!-- Custom scripts for all pages-->
  <script src="/sistemaUAE/resources/bootstrap/js/sb-admin-2.min.js"></script>

  <!-- Page level plugins -->
  <script src="/sistemaUAE/resources/bootstrap/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="/sistemaUAE/resources/bootstrap/js/demo/chart-area-demo.js"></script>
  <script src="/sistemaUAE/resources/bootstrap/js/demo/chart-pie-demo.js"></script>
