    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <!-- Main Content -->
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Permite agregar Autores al Sistema Bibliotecario</p>

          <div class="d-sm-flex align-items-rigth justify-content-between mb-4 col-md-offset-8">
            
            <button type="submit" href="#addLiteraturaModal" class="d-none d-sm-inline-block btn  btn-primary shadow-sm" data-toggle="modal">
              <i class="fas fa-plus-circle fa-sm text-white-50"></i> Agregar Autor</button >
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Datos de Autor</h6>
            </div>
            <div class="card-body">
...
<!-- MODALES --> 
<!-- Modales y js -->
  <?php include("autor/modal_autor_add.php");?>
  <?php include("autor/modal_autor_edit.php");?>
  <?php include("autor/modal_autor_delete.php");?>
  <script src="../../resources/js/administrador/autor.js"></script>
