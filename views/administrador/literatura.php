    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <!-- Main Content -->
        ...
        <div class="container-fluid">
          <br>
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Tipos de Literatura</h1>
          <p class="mb-4">Permite agregar Tipos de Literatura al Sistema Bibliotecario</p>
          ...
          <div class="d-sm-flex align-items-rigth justify-content-between mb-4 col-md-offset-8">
            ...
            <button type="submit" href="#addLiteraturaModal" class="d-none d-sm-inline-block btn  btn-primary shadow-sm" data-toggle="modal">
              <i class="fas fa-plus-circle fa-sm text-white-50"></i> Agregar Tipo Literatura</button >
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Datos de Tipo Literatura</h6>
            </div>
            <div class="card-body">
