		...
		function load(page){
			...
			$("#loader").fadeIn('slow');
			$.ajax({
				url:'../../model/autor/listar_autor.php',
				data: parametros,
		...
		$( "#edit_autor" ).submit(function( event ) {
		  var parametros = $(this).serialize();
			$.ajax({
					type: "POST",
					url: "../../model/autor/editar_autor.php",
					data: parametros,
					 beforeSend: function(objeto){
		...
		$( "#add_autor" ).submit(function( event ) {
		  var parametros = $(this).serialize();
			$.ajax({
					type: "POST",
					url: "../../model/Autor/guardar_autor.php",
					data: parametros,
					 beforeSend: function(objeto){
						$("#resultados").html("Enviando...");
					  },
		...
		$( "#delete_autor" ).submit(function( event ) {
		  var parametros = $(this).serialize();
			$.ajax({
					type: "POST",
					url: "../../model/autor/eliminar_autor.php",
					data: parametros,
					 beforeSend: function(objeto){
						$("#resultados").html("Enviando...");
					  },
